...
from vp_mysql_connection import vinepair_creds
ingest = Ingest()

creds = vinepair_creds()

target_start="2019-07-20"
...
missing_days.sort()
#ingest.get_google_data(db_session,missing_days,db_session.pindex_lookup,targets=["st"])
ingest.get_google_data(db_session,target_dt_list,db_session.pindex_lookup,targets=["st"])
